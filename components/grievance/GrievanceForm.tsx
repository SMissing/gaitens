    ...
    <Card className="bg-[#1e1e1e] rounded-2xl border border-border/50">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Label htmlFor="content">What the grievance is *</Label>
            <Textarea
              id="content"
              value={content}
          ...
          <div>
            <Label htmlFor="relatesToEmployment">How it relates to your employment *</Label>
            <Textarea
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              {relatesToEmployment.length}/1000 characters
            </p>
          </div>

          <div>
            <Label htmlFor="howToResolve">How the problem could be resolved *</Label>
            <Textarea
              id="howToResolve"
              value={howToResolve}
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              {howToResolve.length}/1000 characters
            </p>
          </div>

          <div>
            <Label htmlFor="otherParties">Who are the other parties involved? *</Label>
            <Textarea
              id="otherParties"
              value={otherParties}
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              {otherParties.length}/500 characters
            </p>
          </div>

          <div>
            <Label htmlFor="whatHasBeenDone">What has been done to date to resolve the problem or concern? *</Label>
            <Textarea
              id="whatHasBeenDone"
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              {whatHasBeenDone.length}/1000 characters
            </p>
          </div>
